...
const STATUSVIESTIT = {
    ...
    EI_LOYTYNYT: numero => ({
        viesti: `Annetulla numero:lla ${numero} ei löytynyt peliä`,
        statuskoodi:STATUSKOODIT.EI_LOYTYNYT,
        tyyppi:'virhe'
    }),
    LISAYS_OK: numero =>({
        viesti:`Peli ${numero} lisättiin`,
        statuskoodi:STATUSKOODIT.LISAYS_OK,
        tyyppi:'info'
    }),
    EI_LISATTY: () =>({
        viesti:'Peliä ei lisätty',
        statuskoodi:STATUSKOODIT.EI_LISATTY,
        tyyppi:'virhe'
    }),
    JO_KAYTOSSA: numero => ({
        viesti:`Peli numero ${numero} oli jo käytössä`,
        statuskoodi:STATUSKOODIT.JO_KAYTOSSA,
        tyyppi:'virhe'
    }),
    POISTO_OK: numero => ({
        viesti:`Peli numero ${numero} poistettiin`,
        statuskoodi:STATUSKOODIT.POISTO_OK,
        tyyppi:'info'
    }),
    EI_POISTETTU: () => ({
        viesti:'Annetulla numerolla ei löytynyt peliä. Mitään ei poistettu',
        statuskoodi:STATUSKOODIT.EI_POISTETTU,
        tyyppi:'virhe'
    }),
    PAIVITYS_OK: numero => ({
        viesti:`Pelin ${numero} tiedot päivitettiin`,
